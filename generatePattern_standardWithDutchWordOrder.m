...
order_constituent1 = zeros(1,89); 
order_constituent2 = zeros(1,89);
order_constituent3 = zeros(1,89);
order_constituent4 = zeros(1,89);

active_constituent1 = zeros(1,89); 
active_constituent2 = zeros(1,89);
active_constituent3 = zeros(1,89);
active_constituent4 = zeros(1,89);
...
if act == 1 %"wear"
    ...
    pas = randi(100,1); %sentence in passive voice? (> 90 = yes)
    ...
    elseif (age > 90) && (age < 101) 
      ...
      if pas > 90 %10% of sentences are in passive voice -> change word order 
                 %and add 'was by'
...
elseif act == 2; %eat
       ...
       sit_c = randi(2,1); %"situation" constituent presented?
              ...
              c = c+1;
                    ...
                    filler_act(1,1:171)=sem(6).vec;%drink 
                        ...
                        c = c+1;
                                ...
                                elseif pat > 60 
                                filler_pat(1,1:171)=sem(44).vec;%cacao                 
                                if c == 3            %alle mögl? vielleicht besser nur die realistischen
                                    constituent3(44)=1;
                                elseif c == 4
                                    constituent4(44)=1;
                                end
...
ID = fopen ('sentence_standardWithDutchWordOrder.pat','w'); 
fprintf(ID,'sen1');
...
ID2 = fopen('roleFiller_standardWithDutchWordOrder.pat','w');
