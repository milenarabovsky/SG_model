all_feat = {'passive_voice','woman','man','girl','boy','drink_v','eat','feed','fish','plant','water','play','wear','read','write','look_at','like','kitchen','living_room','garden','lake','park','balkony','river','backyard','veranda','bedroom',...
